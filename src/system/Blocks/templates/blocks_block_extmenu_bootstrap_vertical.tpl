{pageaddvar name="stylesheet" value="system/Blocks/style/extmenu_bootstrap_vertical.css"}
<nav class="navbar navbar-default extmenu-vertical" role="navigation">
    <div class="container-fluid extmenu-vertical extmenu-{$blockinfo.bid}">
